...
let color = "#6100c9"; // this is the color of the embed
    ...
    if (!args[0]) {
      ...
      const row = new MessageActionRow().addComponents(
        new MessageButton()
          ...
          .setStyle("LINK")
          .setURL(
            "https://discord.com/api/oauth2/authorize?client_id=881214410742448179&permissions=8&scope=bot%20applications.commands"
          )
      );
