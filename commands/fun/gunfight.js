...
module.exports = {
  name: "gunfight",
  aliases: ["standoff"],
  description: ":cowboy: :gun: :boom: become a cowboy ig.",
  ...
  run: async (client, message, args, Discord) => {
    ...
    const positions = {
      three:
        "_ _        :cowboy: :point_right:      **3**        :point_left: :cowboy:",
      two: "_ _        :cowboy: :point_right:      **2**        :point_left: :cowboy:",
      one: "_ _        :cowboy: :point_right:      **1**        :point_left: :cowboy:",
      go: "_ _        :cowboy: :point_right:      **GO!**        :point_left: :cowboy:",
      ended1:
        "_ _     :cowboy: :point_right:      **STOP!**        :boom: :cowboy:",
      ended2:
        "_ _     :cowboy: :boom:      **STOP!**        :point_left: :cowboy:",
    };
